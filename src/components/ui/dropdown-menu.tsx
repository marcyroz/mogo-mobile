...
function DropdownMenuItem({
  ...
  return (
    <TextClassContext.Provider
      value={cn(
        'select-none text-lg text-popover-foreground group-active:text-popover-foreground',
        variant === 'destructive' && 'text-destructive group-active:text-destructive'
      )}>
      <DropdownMenuPrimitive.Item
        className={cn(
          'active:bg-accent group relative flex flex-row items-center gap-1 rounded-sm px-2 py-2 sm:py-1.5',
          Platform.select({
            web: cn(
...
function DropdownMenuCheckboxItem({
  ...
  return (
    <TextClassContext.Provider value="text-lg text-popover-foreground select-none group-active:text-accent-foreground">
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      className={cn(
        'text-foreground px-2 py-2 text-lg font-medium sm:py-1.5',
        inset && 'pl-8',
        className
      )}
      {...props}
